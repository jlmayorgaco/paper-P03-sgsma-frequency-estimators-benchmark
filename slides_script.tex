...
\begin{minipage}[t]{0.585\textwidth}
  \vspace{0pt}
  \fcolorbox{ofbLine}{white}{\includegraphics[page=#1,width=\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax]{slide.pdf}}\\[-0.1em]
  {\scriptsize\color{ofbBlue}Click/page #1 of 74 \quad Source: \texttt{slide.pdf}}
\end{minipage}\hfill
...
\item Contributions: OpenFreqBench, a common estimator execution contract, metric-complete comparison, and evidence that compliance-style tests miss IBR failure modes.
...
\s{26}{Scenario stress families}{Explain harmonics, interharmonics, OOB, and SNR before estimator families.}{
\item This slide defines the stress families that are easy to confuse: integer harmonics, non-integer interharmonics, out-of-band tones, and additive noise.
\item The key distinction is that many of these cases keep the true frequency nominal. If the estimator moves, that is a measurement artifact caused by waveform distortion, leakage, or low SNR.
\item Use the equations only as anchors: THD controls integer harmonic distortion; SNR is tied to the noise standard deviation relative to a 1 pu sine.
}
\s{27}{Estimator families}{Explain why family behavior matters.}{
...
\s{28}{Metrics}{Define the scorecard.}{
...
\s{29}{Core evidence divider}{Shift from method to results.}{
...
\s{30}{Standard results: stable methods}{Read the heatmap first.}{
...
\s{31}{Standard results: divergence appears}{Explain the red cells.}{
...
\s{32}{Phase jump family separator}{Use the mechanism diagram.}{
...
\s{33}{Composite IBR sequence}{Explain why this is hardest.}{
...
\s{34}{Scenario E leaderboard breaks}{Make the result uncomfortable.}{
...
\s{35}{Trip-risk evidence}{Separate trip exposure from RMSE.}{
...
\s{36}{Trace-visible failures}{Use the plots as evidence.}{
...
\s{37}{Question-dependent winners}{Summarize the core table.}{
...
\s{38}{Computational feasibility}{Clarify CPU interpretation.}{
...
\s{39}{Deployment limits}{Read the Pareto structure.}{
...
\s{40}{Balance profile}{Use the radar as a quick synthesis.}{
...
\s{41}{Compliance heatmap: first read}{Show the standard-test limitation.}{
...
\s{42}{Compliance heatmap: failure read}{State the punchline.}{
...
\s{43}{Empirical claims}{Consolidate the core evidence.}{
...
\s{44}{Expanded and ATLAS divider}{Open the extended evidence.}{
...
\s{45}{Expanded stress analysis}{Explain the two evidence layers.}{
...
\s{46}{Family winners}{State the no-universal-winner pattern.}{
...
\s{47}{ATLAS method}{Explain the readiness pipeline.}{
...
\s{48}{Metric choice changes the answer}{Make this a headline result.}{
...
\s{49}{Where estimators stop being valid}{Read the threshold table.}{
...
\s{50}{AM, FM, interharmonics}{Separate distortion types.}{
...
\s{51}{Textbook EKF divergence}{Explain the RA-EKF value.}{
...
\s{52}{RoCoF sign asymmetry}{Make the sign result memorable.}{
...
\s{53}{Phase-jump non-monotonicity}{Explain why one nominal point is weak.}{
...
\s{54}{No estimator owns stress space}{Show rotation of champions.}{
...
\s{55}{ZCD: low-stress champion}{Start the paradox slowly.}{
...
\s{56}{ZCD: broadband-noise cliff}{Reveal the failure mode.}{
...
\s{57}{ZCD: harmonic cliff}{Complete the paradox.}{
...
\s{58}{Sag and swell asymmetry}{Give the theory intuition.}{
...
\s{59}{Why sag breaks ZCD}{Explain the equation physically.}{
...
\s{60}{Harmonic degradation}{Use family slopes, not single points.}{
...
\s{61}{CPU-accuracy Pareto}{Turn the plot into a deployment message.}{
...
\s{62}{Findings and deployment divider}{Prepare the conclusion.}{
...
\s{63}{Three findings}{Deliver the thesis in three points.}{
...
\s{64}{Validity limits}{Be candid and precise.}{
...
\s{65}{Recommendation map: first layer}{Start with event class.}{
...
\s{66}{Recommendation map: FFR/RoCoF}{Explain the first recommendation.}{
...
\s{67}{Recommendation map: anti-islanding}{Explain protection-adjacent use.}{
...
\s{68}{Recommendation map: low-cost relays}{Explain embedded feasibility.}{
...
\s{69}{Recommendation map: metering-like state}{Explain steady-state use.}{
...
\s{70}{Qualification profile}{Define the standardization direction.}{
...
\s{71}{Standardization profile}{Connect to future standards without overclaiming.}{
...
\s{72}{IBR Event Qualification Score}{Explain the composite metric.}{
...
\s{73}{Toward realtime IBR estimators}{Describe what the results enable.}{
...
\s{74}{Conclusion}{End with the single sentence they should remember.}{
