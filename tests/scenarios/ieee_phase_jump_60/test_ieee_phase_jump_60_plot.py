...
def test_ieee_phase_jump_60_plot_and_csv():
    out_dir = ROOT / "tests" / "scenarios" / "ieee_phase_jump_60" / "artifacts"
    out_dir.mkdir(parents=True, exist_ok=True)

    # Generamos el escenario con los parámetros de estrés
    t_jump = 0.7
    ...
    csv_path = out_dir / "ieee_phase_jump_60.csv"
    ...
    axes[0].set_title("Large Phase Jump Stress Test (+60°)")
    ...
    png_path = out_dir / "ieee_phase_jump_60.png"
