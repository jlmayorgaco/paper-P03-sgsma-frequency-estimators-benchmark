...
def test_lkf2_vs_zcd_visual_diagnostic():
    out_dir = ROOT / "tests" / "estimators" / "lkf2" / "artifacts"
    ...
    axes[1].plot(
        ...
        linewidth=2.0,
        color="crimson",
        label="LKF2 (phase-based alternative implementation)",
    )
    axes[1].axvline(
        t_step,
        color="gray",
    ...
    axes[1].set_title("Dynamic Tracking: ZCD Latency vs. LKF2 Phase-Based Tracking")
    axes[1].set_ylim(48.0, 54.5)
    axes[1].grid(True, alpha=0.3)
    axes[1].legend(loc="lower right")

    plot_path = out_dir / "lkf2_vs_zcd_diagnostic.png"
