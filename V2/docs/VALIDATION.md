...
The release gate additionally requires a clean `V2/` package subtree and release
metadata suitable for public archival. This lets OpenFreqBench be released from
inside the larger research repository without blocking on unrelated root-level
work in progress.
