...
def configure_voltage_mag_step_fixed_policy_profile() -> None:
    ...
    _set_default("ASTEP_OUTPUT_SUBDIR", "atlas_magnitude_step_fixed_policy")
    _set_default("ASTEP_SWEEP_INCLUDE_ESTIMATORS", CANONICAL_ESTIMATORS)
...
if __name__ == "__main__":
    ...
    from pipelines.magnitude_step_sweep_fixed_policy import main
