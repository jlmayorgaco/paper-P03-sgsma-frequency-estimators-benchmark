...
class IEEEPhaseJump60Scenario(Scenario):
    """
    Large phase-jump stress test (60 degrees).

    Intended for:
    - Severe phase discontinuity robustness evaluation.
    - Stress testing estimator recovery after a large instantaneous phase jump.
    """

    SCENARIO_NAME: ClassVar[str] = "IEEE_Phase_Jump_60"
    ...
    DEFAULT_PARAMS: ClassVar[dict[str, Any]] = {
        ...
        "phase_rad": 0.0,
        "amplitude": 1.0,
        "phase_jump_rad": math.pi / 3.0,  # +60 grados
    ...
    MONTE_CARLO_SPACE: ClassVar[dict[str, Any]] = {
        "phase_jump_rad": {
            "kind": "uniform",
            "low": math.pi / 4.0,   # +45 grados
            "high": 5.0 * math.pi / 12.0,  # +75 grados
        },
        "t_jump_s": {
            "kind": "uniform",
            "low": 0.5,
    ...
    def generate(
        ...
        meta = {
            "description": f"Large Phase Jump (+{jump_deg}°)",
            "standard": "Large phase discontinuity stress test",
            "parameters": {
            ...
            "purpose": "Evaluate estimator robustness and recovery under severe phase discontinuity.",
