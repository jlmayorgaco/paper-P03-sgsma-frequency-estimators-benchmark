...
No active `known_numerical_debt` tests remain after Phase 2-B.
...
1. add a `phase2-paper-grade-preview.yaml`;
2. run a medium-size paper-grade preview before widening to final runs;
3. keep LKF/LKF2 canonical only if preview metrics remain stable across scenarios.
