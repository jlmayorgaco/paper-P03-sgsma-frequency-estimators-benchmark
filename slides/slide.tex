...
\begin{itemize}
  ...
  \item The result is a reproducible selection protocol: choose by event family, metric, and compute budget.
\end{itemize}
...
\end{columns}
\vspace{0.35em}
\callout{The stress-test protocol links RA-EKF design choices to phase-jump false-trip exposure.}
\end{frame}
...
\sectionframe{ofbViolet}{2. Benchmark Gap}{Standards, datasets, estimator evidence.}
...
\begin{frame}{Benchmark gaps in prior work}
\scriptsize
\renewcommand{\arraystretch}{1.18}
...
\sectionframe{ofbBlue}{6. Evidence Profile}{Qualification logic and next validation.}

\begin{frame}{Benchmark evidence profile}
\begin{center}
\begin{tikzpicture}[
  every node/.style={font=\scriptsize},
...
\end{itemize}
\column{0.43\linewidth}
\begin{block}{Composite metric rationale}
\small
...
\begin{itemize}
  ...
  \item Estimators that optimize an objective vector: frequency error, RoCoF, trip exposure, settling, CPU, and latency.
\end{itemize}
\end{block}
\end{columns}
\vspace{0.35em}
