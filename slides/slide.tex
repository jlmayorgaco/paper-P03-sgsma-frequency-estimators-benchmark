...
\node[result, fill=ofbSoft, draw=ofbViolet] at (9.45,0.28) {core table\\60-run sweep\\ATLAS pilot\\validation gate};
...
\sectionframe{ofbBlue}{6. Deployment Profile}{Qualification logic and next validation.}
...
\end{columns}
\vspace{0.35em}
\callout{Next validation step: evaluate each estimator against declared event regimes, latency limits, and compute envelopes.}
\end{frame}
