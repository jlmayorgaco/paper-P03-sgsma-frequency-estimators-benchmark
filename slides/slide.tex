...
\end{center}
\vspace{-0.05cm}
\callout{Result (mean over 5 seeds): RA-EKF, SOGI-FLL, Koopman and TFT stay $\le0.05$ Hz on all three, but \textbf{EKF and IpDFT intermittently diverge on the ramp} (37 and 14 Hz) and PLL degrades on ramp/modulation. Robustness, not point accuracy, separates the families.}
\vspace{-0.05cm}
